...
/***/ function(module, exports, __webpack_require__) {
	...
	var AsyncValya = (function (_React$Component) {
	    _inherits(AsyncValya, _React$Component);

	    _createClass(AsyncValya, null, [{
	        key: 'displayName',
	        value: 'AsyncValya',
	        enumerable: true
	    }]);

	    function AsyncValya(props) {
	        _classCallCheck(this, AsyncValya);

	        _get(Object.getPrototypeOf(AsyncValya.prototype), 'constructor', this).call(this, props);
	...
	_reactDom2['default'].render(_react2['default'].createElement(AsyncValya, null), document.querySelector('.main'));
