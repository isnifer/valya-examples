...
/***/ function(module, exports, __webpack_require__) {
	...
	var ValyaExamples = (function (_React$Component) {
	    _inherits(ValyaExamples, _React$Component);

	    _createClass(ValyaExamples, null, [{
	        key: 'displayName',
	        value: 'ValyaExamples',
	        enumerable: true
	    }]);

	    function ValyaExamples(props) {
	        _classCallCheck(this, ValyaExamples);

	        _get(Object.getPrototypeOf(ValyaExamples.prototype), 'constructor', this).call(this, props);

	        this.state = {
	            examples: ['original', 'initialValidation', 'multipleValidators', 'externalValidator', 'async', 'foma', 'fomaWarning', 'birthday', 'unlimitedGroups', 'emailPhone']
	        };
	    }

	    _createClass(ValyaExamples, [{
	        key: 'render',
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'h2',
	                    { className: 'header' },
	                    'Valya (foma, foma-warning) examples'
	                ),
	                _react2['default'].createElement(
	                    'ul',
	                    { className: 'valya-examples' },
	                    this.state.examples.map(function (example, i) {
	                        return _react2['default'].createElement(
	                            'li',
	                            { className: 'valya-examples__item', key: i },
	                            _react2['default'].createElement(
	                                'a',
	                                { className: 'valya-examples__link', href: example },
	                                example
	                            )
	                        );
	                    })
	                ...
	                _react2['default'].createElement(
	                    'a',
	                    { href: 'https://github.com/isnifer/valya-examples' },
	    ...
	    return ValyaExamples;
	})(_react2['default'].Component);

	_reactDom2['default'].render(_react2['default'].createElement(ValyaExamples, null), document.querySelector('.main'));
